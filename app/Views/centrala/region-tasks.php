...
<div id="view-centrala-region-tasks" class="fade-in">
    ...
    <div class="mb-4">
        <h3 class="fw-bold m-0 text-dark">Sarcini - <?= esc($region['name']) ?></h3>
        <p class="text-muted m-0 mt-1">Sarcinile din această regiune.</p>
    </div>

    <?php if (empty($tasks)): ?>
        <div class="text-center py-5">
            <i class="bi bi-inbox display-1 text-muted"></i>
            <p class="text-muted mt-3">Nu există sarcini în această regiune.</p>
        </div>
    <?php else: ?>
        <div class="row g-4">
