...
<div id="view-centrala-admin-tasks" class="fade-in">
    <a href="<?= site_url('centrala') ?>" class="btn btn-link text-secondary text-decoration-none p-0 mb-4 fw-medium" style="font-size: 0.85rem;">
        <i class="bi bi-arrow-left me-1"></i> Înapoi la Centrala
    </a>

    <div class="mb-4">
        <h3 class="fw-bold m-0 text-dark">Sarcini - <?= esc($adminName) ?></h3>
        <p class="text-muted m-0 mt-1">Sarcinile asignate administratorului.</p>
    </div>

    <?php if (empty($tasks)): ?>
        <div class="text-center py-5">
            <i class="bi bi-inbox display-1 text-muted"></i>
            <p class="text-muted mt-3">Nu există sarcini asignate acestui administrator.</p>
        </div>
    <?php else: ?>
        <div class="row g-4">
