...
<div id="view-dashboard" class="fade-in">
    <div class="d-flex justify-content-between align-items-end mb-5">
        <div>
            <h3 class="fw-bold m-0 text-dark">Dashboard Director</h3>
        ...
        <?php if (empty($regions)): ?>
            <div class="col-12">
                <div class="spor-card p-4 text-center">
                    <p class="text-muted mb-0">Nu există sucursale disponibile.</p>
                </div>
            </div>
        <?php else: ?>
...
<div id="view-region" class="d-none fade-in">
    <div class="mb-5 border-bottom border-light pb-4">
        <h3 class="fw-bold text-dark" id="region-title">Sucursală</h3>
