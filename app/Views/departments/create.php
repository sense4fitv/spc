...
<div id="view-add-department" class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 border-bottom border-light pb-4">
        <h3 class="fw-bold text-dark m-0">Adaugă Departament Nou</h3>
    </div>
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="spor-card p-5">
                <?= form_open('departments/store', ['id' => 'createDepartmentForm']) ?>
                <?= csrf_field() ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" class="form-control" value="<?= old('name') ?>" placeholder="Ex: Financiar, Operațional" required>
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        <input type="color" name="color_code" class="form-control form-control-color" value="<?= old('color_code', '#808080') ?>" title="Alege culoarea">
                        <input type="text" name="color_code_text" id="colorCodeText" class="form-control" value="<?= old('color_code', '#808080') ?>" placeholder="#808080" pattern="^#[0-9A-Fa-f]{6}$" maxlength="7">
                        <div id="colorPreview" style="width: 40px; height: 40px; background-color: <?= old('color_code', '#808080') ?>; border-radius: 8px; border: 2px solid #ddd;"></div>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-3">
                    ...
                    <button type="submit" class="btn btn-spor-primary px-4">Creează Departament</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
